...
/* Escrita crua de ADCCONTROL2 -- so diagnostico ao vivo (POST
 * /api/mic/input). Para uso normal, es8388_mic_set_input_mode(), que
 * escreve 0x0A e 0x0B em par e memoriza a escolha. */
